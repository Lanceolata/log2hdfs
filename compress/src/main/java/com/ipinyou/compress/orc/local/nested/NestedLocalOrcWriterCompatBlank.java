 ...
 */
public class NestedLocalOrcWriterCompatBlank extends NestedLocalOrcWriterCompat {

    public NestedLocalOrcWriterCompatBlank(String filePath, TypeDescription schema,
