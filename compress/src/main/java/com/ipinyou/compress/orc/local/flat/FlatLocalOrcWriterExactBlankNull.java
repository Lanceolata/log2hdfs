 ...
 */
public class FlatLocalOrcWriterExactBlankNull extends FlatLocalOrcWriterExact {

    public FlatLocalOrcWriterExactBlankNull(String filePath, TypeDescription schema,
    ...
    protected boolean checkNull(String col, String fieldType) {
        if ("".equals(col) || "null".equalsIgnoreCase(col)) {
            return true;
        }
        return false;
    }
