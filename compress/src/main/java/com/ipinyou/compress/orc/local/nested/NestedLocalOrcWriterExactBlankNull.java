 ...
 */
public class NestedLocalOrcWriterExactBlankNull extends NestedLocalOrcWriterExact {

    public NestedLocalOrcWriterExactBlankNull(String filePath, TypeDescription schema,
