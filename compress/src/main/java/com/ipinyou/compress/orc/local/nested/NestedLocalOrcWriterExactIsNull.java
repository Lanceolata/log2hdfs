 ...
 */
public class NestedLocalOrcWriterExactIsNull extends NestedLocalOrcWriterExact {

    public NestedLocalOrcWriterExactIsNull(String filePath, TypeDescription schema,
