 ...
 */
public class NestedLocalOrcWriterCompatIsNull extends NestedLocalOrcWriterCompat {

    public NestedLocalOrcWriterCompatIsNull(String filePath, TypeDescription schema,
