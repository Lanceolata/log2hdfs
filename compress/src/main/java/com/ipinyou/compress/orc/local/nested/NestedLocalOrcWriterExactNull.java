 ...
 */
public class NestedLocalOrcWriterExactNull extends NestedLocalOrcWriterExact {

    public NestedLocalOrcWriterExactNull(String filePath, TypeDescription schema,
