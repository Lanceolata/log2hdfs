 ...
 */
public class NestedLocalOrcWriterExactBlank extends NestedLocalOrcWriterExact {

    public NestedLocalOrcWriterExactBlank(String filePath, TypeDescription schema,
