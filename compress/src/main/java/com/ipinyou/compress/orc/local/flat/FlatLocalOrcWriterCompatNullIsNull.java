 ...
 */
public class FlatLocalOrcWriterCompatNullIsNull extends FlatLocalOrcWriterCompat {

    public FlatLocalOrcWriterCompatNullIsNull(String filePath, TypeDescription schema,
