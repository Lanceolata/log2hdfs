 ...
 */
public class FlatLocalOrcWriterExactNullIsNull extends FlatLocalOrcWriterExact {

    public FlatLocalOrcWriterExactNullIsNull(String filePath, TypeDescription schema,
