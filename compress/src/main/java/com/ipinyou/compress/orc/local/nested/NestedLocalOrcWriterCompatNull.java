 ...
 */
public class NestedLocalOrcWriterCompatNull extends NestedLocalOrcWriterCompat {

    public NestedLocalOrcWriterCompatNull(String filePath, TypeDescription schema,
