 ...
 */
public class NestedLocalOrcWriterExactNullIsNull extends NestedLocalOrcWriterExact {

    public NestedLocalOrcWriterExactNullIsNull(String filePath, TypeDescription schema,
