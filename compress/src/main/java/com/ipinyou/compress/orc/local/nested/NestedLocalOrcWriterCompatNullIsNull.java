 ...
 */
public class NestedLocalOrcWriterCompatNullIsNull extends NestedLocalOrcWriterCompat {

    public NestedLocalOrcWriterCompatNullIsNull(String filePath, TypeDescription schema,
